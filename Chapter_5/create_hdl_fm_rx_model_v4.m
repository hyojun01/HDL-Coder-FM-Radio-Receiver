% create_hdl_fm_rx_model_v4.m
% Version compatible with MATLAB releases where Unit Delay
% does not support OutDataTypeStr
...
set_param([subsys '/Out1'],'Position',[1160 138 1190 152]);
...
% Cast delay output to controlled type
add_block('simulink/Signal Attributes/Data Type Conversion',[subsys '/DC_yCast'],...
    'Position',[920 300 1000 330],...
...
add_line(subsys,'DC_yDelay/1','DC_yCast/1');
add_line(subsys,'DC_yCast/1','DC_a/1');
...
disp('Model created (v4): fm_rx_model.slx');
disp('Run HDL with:');
